        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-10">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="card-editorial p-6 sm:p-7 space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 text-[11px] font-mono text-slate-500 hover:text-slate-900 mt-1 font-light transition-colors cursor-pointer"
                  >
              ...
              {/* Response SLA */}
              <div className="p-3.5 rounded-lg bg-slate-50 border border-slate-100/80 flex items-center gap-3 text-xs text-slate-600 font-light">
            ...
            <div className="card-editorial p-6 space-y-3">
              ...
              <a
                ...
                className="btn-ios-secondary px-4 py-2 rounded-full text-[10px] font-mono uppercase tracking-widest inline-flex items-center gap-2 transition-colors"
              >
          ...
          <div className="lg:col-span-7">
            <form
              ...
              className="card-editorial p-6 sm:p-8 space-y-5"
            >
