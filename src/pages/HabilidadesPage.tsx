...
export const HabilidadesPage: React.FC = () => {
  const { isSpanish } = useLanguage();
  const [activeSection, setActiveSection] = useState<string>('habilidades');
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    analyticsService.trackEvent('habilidades_page_viewed', {});
  }, []);
